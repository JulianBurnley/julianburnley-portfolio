...
#ss your knowledge and skills of the web development life cycle. In this lesson, you will continue from the project plan you developed in Lesson 5 to build, test, and publish the web site using GitHub pages.
 Lesson 6 Project
This project will asse
## Project Scenario
